...
export const slides: SlideData[] = [
  ...
  { slug: 'traction', title: 'Mostly Right — And we\'re already doing it. Profitably.', description: '75% accuracy over 60 days. When the data breaks, we lose money.', prev: 'intro', next: 'origin' },
