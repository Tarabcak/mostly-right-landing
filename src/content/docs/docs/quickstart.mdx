...
import Eyebrow from '../../../components/docs/Eyebrow.astro';
import Lead from '../../../components/docs/Lead.astro';
import Steps from '../../../components/docs/Steps.astro';
import { Tabs, TabItem } from '@astrojs/starlight/components';

<Eyebrow>Get started</Eyebrow>

<Lead>Install the SDK, request a private-beta API key, and pull your first point-in-time weather observation in under five minutes.</Lead>

<Steps steps={[
  { n: '01', t: 'Install the SDK' },
  { n: '02', t: 'Get an API key' },
  { n: '03', t: 'Your first call' },
]} />
