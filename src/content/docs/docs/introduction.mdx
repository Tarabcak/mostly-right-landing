---
title: Introduction
description: Settlement truth layer for prediction markets. What Mostly Right is and who it's for.
eyebrow: Overview
---

import Lead from '../../../components/docs/Lead.astro';

<Lead>Mostly Right is a data API for prediction markets. It starts with weather because weather settles first, fastest, and hardest on Kalshi.</Lead>
